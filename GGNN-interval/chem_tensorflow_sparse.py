...
import chem_tensorflow_interval
...
class SparseGGNNChemModel(ChemModel):
    ...
    def prepare_specific_graph_model(self) -> None:
        ...
        self.placeholders['fileHash'] = tf.placeholder(tf.int32, [None], name='fileHash')
    ...
    def convertInitialNodeRep():
        x = self.placeholders['initial_node_representation']
    ...
    def process_raw_graphs(self, raw_data: Sequence[Any], is_training_data: bool) -> Any:
        ...
        print("total graph: %d and aveNodes: %f" %
                (totalNumOfWholeGraphs, float(totalNumOfNodes)/totalNumOfWholeGraphs))
        if is_training_data:
